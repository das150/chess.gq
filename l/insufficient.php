...
$link = mysqli_connect("XXXXXXXX", "XXXXXXXX", "XXXXXXXX", "XXXXXXXX");
...
if(isset($_SESSION['id'])){
	$sql = "UPDATE `accountest` SET draws = draws + 1 WHERE id = '$account';";
}
...
?>
    ...
    <!-- Webpage Title -->
    <title>Draw by insufficient material!</title>
...
<div class="deco-white-circle-1"><img src="https://raw.githubusercontent.com/das150/chess.gq/de97eb6a7ae49c3e905cb899f026e563d2d8bb78/decorative-white-circle.svg"></div>
  ...
  <div class="container" style="position: absolute; left: 50%; top: 48%; -ms-transform: translate(-50%, -50%); transform: translate(-50%, -50%);">
        ...
        <h1 style="line-height: 1.5; color: #4a4a4a; margin-bottom: 35px;"><b>Draw by insufficient material!</b></h1></center>
        <?php
                    session_start();
