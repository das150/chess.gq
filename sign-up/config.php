...
define('CONTACTFORM_FROM_ADDRESS', 'chessdotgq@gmail.com');
define('CONTACTFORM_FROM_NAME', 'Chess.gq');
...
define('CONTACTFORM_TO_ADDRESS', 'XXXXXXXXXXXX');
...
define('CONTACTFORM_SMTP_USERNAME', 'chessdotgq@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'XXXXXXXXXXXXXXXXXXX');

// The reCAPTCHA credentials for your site. You can get these at https://www.google.com/recaptcha/admin
define('CONTACTFORM_RECAPTCHA_SITE_KEY', 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');
